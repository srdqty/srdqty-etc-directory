/*
  I added websocket_client package because the wee-slack plugin requires it
*/
...
let
  inherit (pythonPackages) python pycrypto pync websocket_client;
in
...
stdenv.mkDerivation rec {
  ...
  buildInputs = with stdenv.lib; [
      ...
      libgcrypt pycrypto websocket_client makeWrapper
      cmake
      asciidoctor
      ]
